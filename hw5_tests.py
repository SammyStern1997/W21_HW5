...
class TestCard(unittest.TestCase):
    ...
    def test_q3(self):
        ...
        self.assertEqual(str(c1), "King of Spades")l
        return ans
    ...
    def test_q5(self):
        ...
        self.assertEqual(type(d1.deal_card()), type(hw5_cards.Card))
        return ans
    ...
    def test_q7(self):
        ...
        self.assertEqual(length1+1, length2, 52)
        return ans
